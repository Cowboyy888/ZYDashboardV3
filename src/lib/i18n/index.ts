...
export const dictionary = {
  ...
  'common.removeLine': { en: 'Remove line', zh: '删除此行' },
  ...
  'emp.workLocation': { en: 'Location', zh: '所在场所' },
  'emp.office': { en: 'Office', zh: '办公室' },
  'emp.factory': { en: 'Factory', zh: '工厂' },
  ...
  'pur.dashDesc': {
    en: 'Open purchase orders and their status.',
    zh: '未结采购订单及其状态。',
  },
  ...
  'sal.printInvoice': { en: 'View Deposit Invoice PDF', zh: '查看定金发票 PDF' },
  'sal.printBalanceInvoice': { en: 'View Balance Invoice PDF', zh: '查看尾款发票 PDF' },

  // --- Deposit/balance paid flags (0037) --------------------------------------------
  'sal.depositPaid': { en: 'Deposit paid', zh: '已付定金' },
  'sal.balanceDue': { en: 'Balance due', zh: '尾款余额' },
  'sal.markDepositPaid': { en: 'Mark Deposit Paid', zh: '标记定金已付' },
  'sal.markBalancePaid': { en: 'Mark Balance Paid', zh: '标记尾款已付' },
  'sal.depositPaidOn': { en: 'Deposit paid on', zh: '定金付款日期' },
  'sal.balancePaidOn': { en: 'Balance paid on', zh: '尾款付款日期' },
  'sal.depositPending': { en: 'Deposit pending', zh: '定金待付' },
  'sal.balancePending': { en: 'Balance pending', zh: '尾款待付' },
