...
export const dictionary = {
  ...
  'emp.payType': { en: 'Pay type', zh: '计薪方式' },
  ...
  'inq.desc': {
    en: 'Customer price inquiries and quotations. Prices are per square metre ($/m²).',
    zh: '客户询价与报价。单价按平方米（$/m²）计算。',
  },
  'inq.tabInquiries': { en: 'Inquiries', zh: '询价' },
  ...
  'inq.formHint': {
    en: 'Only the customer name is required. Grey values are calculated automatically.',
    zh: '仅客户名称为必填。灰色数值自动计算。',
  },
  'inq.no': { en: 'Inquiry No.', zh: '询价编号' },
  'inq.date': { en: 'Date', zh: '日期' },
  'inq.customer': { en: 'Customer', zh: '客户名称' },
  'inq.company': { en: 'Company', zh: '公司名称' },
  'inq.contact': { en: 'Contact / Telegram', zh: '联系电话 / Telegram' },
  'inq.salesperson': { en: 'Salesperson', zh: '销售员' },
  'inq.customerType': { en: 'Customer type', zh: '客户类型' },
  ...
  'inq.delivery': { en: 'Delivery location', zh: '交货地点' },
  'inq.cost': { en: 'Factory cost ($/m²)', zh: '工厂成本($/m²)' },
  'inq.quoted': { en: 'Quoted ($/m²)', zh: '报价($/m²)' },
  'inq.target': { en: 'Target ($/m²)', zh: '目标价($/m²)' },
  'inq.final': { en: 'Final ($/m²)', zh: '成交价($/m²)' },
  'inq.diff': { en: 'Diff ($/m²)', zh: '价差($/m²)' },
  'inq.profit': { en: 'Est. profit ($)', zh: '预估利润($)' },
  'inq.followupDate': { en: 'Follow-up date', zh: '跟进日期' },
  'inq.followupNotes': { en: 'Follow-up notes', zh: '跟进备注' },
  'inq.nextAction': { en: 'Next action', zh: '下一步行动' },
  'inq.remarks': { en: 'Remarks', zh: '备注' },
  // KPIs
  'inq.kpiTotal': { en: 'Inquiries', zh: '询价数' },
  'inq.kpiValue': { en: 'Quotation value', zh: '报价总额' },
  'inq.kpiWon': { en: 'Won', zh: '成交' },
  'inq.kpiLost': { en: 'Lost', zh: '流失' },
  'inq.kpiConversion': { en: 'Conversion', zh: '成交率' },
  'inq.kpiProfit': { en: 'Won profit', zh: '成交利润' },
  'inq.kpiPending': { en: 'Pending', zh: '待跟进' },
  // Follow-ups
  'inq.addFollowup': { en: 'Record a follow-up', zh: '记录跟进' },
  'inq.recordFollowup': { en: 'Record follow-up', zh: '记录跟进' },
  'inq.noFollowups': { en: 'No follow-ups yet.', zh: '暂无跟进记录。' },
  'inq.nextFollowup': { en: 'Next follow-up', zh: '下次跟进' },
  'inq.responsible': { en: 'Responsible', zh: '负责人' },
  'inq.previousAction': { en: 'Previous action', zh: '上次行动' },
  ...
  'inq.catWon': { en: 'Won', zh: '成交' },
  'inq.catLost': { en: 'Lost', zh: '流失' },
  // Delete
...
const PHRASES: Record<string, string> = {
  ...
  'Status reactivated': '已重新启用状态',
  'That status already exists.': '该状态已存在。',
  'Missing inquiry': '缺少询价',
  'Missing customer type': '缺少客户类型',
  'Missing status': '缺少状态',
  // Generic
